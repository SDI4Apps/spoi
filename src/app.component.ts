...
import { HsConfig, HsLanguageService, HsUtilsService, SparqlJson } from 'hslayers-ng';
...
export class AppComponent { 
  ...
  private symbols: { [key: string]: any } = {
    'car_service': this.HsUtilsService.resolveEsModule(require('../img/symbolsWaze/car_service.png')),
    'bank': this.HsUtilsService.resolveEsModule(require('../img/symbols/bank.png')),
    'atm': this.HsUtilsService.resolveEsModule(require('../img/symbols/atm.png')),
    'cafe': this.HsUtilsService.resolveEsModule(require('../img/symbols/cafe.png')),
    'fast_food': this.HsUtilsService.resolveEsModule(require('../img/symbols/fast_food.png')),
    'pub': this.HsUtilsService.resolveEsModule(require('../img/symbols/pub.png')),
    'restaurant': this.HsUtilsService.resolveEsModule(require('../img/symbols/restaurant.png')),
    'hotel': this.HsUtilsService.resolveEsModule(require('../img/symbols/hotel.png')),
    'supermarket': this.HsUtilsService.resolveEsModule(require('../img/symbols/supermarket.png')),
    'information': this.HsUtilsService.resolveEsModule(require('../img/symbols/information.png')),
    'camp_site': this.HsUtilsService.resolveEsModule(require('../img/symbols/camp_site.png')),
  }  
  ...
  private getStyleOSM(category: string): Style | void {
    let symbolSrc = this.symbols[category];
